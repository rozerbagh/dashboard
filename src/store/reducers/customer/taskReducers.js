...
const taskReducers = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.VM_SHEDULED_TASK_START:
            return {
                ...state,
                loading: true
            }
        case actionTypes.VM_SHEDULED_TASK_SUCCESS:
            return {
                ...state,
                sheduledtaskMsg: action.successMsg,
                loading: false,
            }
        case actionTypes.VM_SHEDULED_TASK_FAIL:
            return {
                ...state,
                loading: false,
        ...
        case actionTypes.VM_REBOOT_START:
            return {
                ...state,
                loading: true
            }
        case actionTypes.VM_REBOOT_SUCCESS:
            return {
                ...state,
                rebootSuccessMsg: action.successMsg,
                loading: false,
            }
        case actionTypes.VM_REBOOT_FAIL:
            return {
                ...state,
                loading: false,
