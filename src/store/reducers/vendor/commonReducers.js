...
const vcommonReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.SET_CUSTOMER:
            return {
                ...state,
                customer_name: action.email,
                customer_id: action.id,
                customer_phone: action.name,
                insideCustomer: action.bool_inside_customer
            }
