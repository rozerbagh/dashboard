...
const ZoomViewTasks = React.memo((props) => {
                    ...
                    <Table>
                        <TableHead>
                            <StyledTableRow key="heading">
                                <StyledTableCell align="left">Instance</StyledTableCell>
...
const mapStateToProps = state => {
    return {
        taskaArr: state.customerZoomView.tasks_list,
        loader: state.customerZoomView.loadingTasks,
    }
}
