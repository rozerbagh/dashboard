    ...
    return (<>
        <TableContainer>
            <div className={classes.tableTitleContainer}>
                <span style={{ fontWeight: 500, fontSize: "0.8rem" }}>External IP Communication
                    | {props.wan_ip}
                </span>
                <div>
            ...
            <Table aria-label="instances-table" aria-label="a dense table">
                <TableHead>
                    <StyledTableRow key={`${props.wan_ip}-title`}>
                        <StyledTableCell>
                            <span style={{ paddingLeft: "20px" }}></span>Internal IP
                        </StyledTableCell>
                        <StyledTableCell align="left">External IP</StyledTableCell>
                ...
                <TableBody>
                    {props.rows.map((row, index) => (
                        <StyledTableRow key={`${props.wan_ip}-${row.id}-ip-tracking`}>
                            <StyledTableCell align="left">
                                <span style={{ paddingLeft: "20px" }}></span>{row.internal_ip}
                            </StyledTableCell>
                            <StyledTableCell align="left">{row.external_ip}</StyledTableCell>
...
export default IPTrackingTable;